...
//    unsigned long hold;         /* local strm->hold */
    ...
    do {
        ...
        //fprintf(stderr, "Here1: %02x %02x %04x\n", here.op, here.bits, here.val);
      dolen:
        ...
        if (op == 0) {                          /* literal */
            ...
            *out++ = (unsigned char)(here.val);
            ...
            //fprintf(stderr, "Here2: %02x %02x %04x\n", here.op, here.bits, here.val);
          dodist:
            op = (unsigned)(here.bits);
            hold >>= op;
            bits -= op;
            ...
            if (op & 16) {                      /* distance base */
...
#ifdef INFLATE_STRICT
                if (dist > dmax) {
                    strm->msg = (char *)"invalid distance too far back 2";
                    state->mode = BAD;
                    break;
                }
#endif
                ...
                if (dist > op) {                /* see if copy from window */
                    ...
                    if (op > whave) {
                        if (state->sane) {
                            strm->msg =
                                (char *)"invalid distance too far back 3";
                            state->mode = BAD;
                            break;
                        }
                ...
                //fprintf(stderr, "Here3: %02x %02x %04x\n", here.op, here.bits, here.val);
                goto dodist;
            }
            else {
            ...
            //fprintf(stderr, "Here4: %02x %02x %04x\n", here.op, here.bits, here.val);
            goto dolen;
        }
